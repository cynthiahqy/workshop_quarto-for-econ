...
::: {layout-ncol="2"}
![](images/Cynthia_Huang.jpg){style="border-radius:50%" height=300px}

-   **Currently:** Research Fellow in EBS Monash _(soon to be LMU Munich)_
-   **Previously:** Economics at Unimelb & SoDa Labs Monash
...
-   [Positron](https://positron.posit.co/) or [VSCode](https://code.visualstudio.com) for editing and rendering Quarto documents and websites
...
-   is an open-source, scientific, and technical publishing system built on [Pandoc](https://pandoc.org/)
...
## My Turn: A Tour of Quarto in Positron
...
## Rendering Options in Positron/VSCode

1. **Option 1:** Press the Preview button

. . .

2. **Option 2:** Use `Quarto: Render Document` from Command Palette (⇧⌘P / Ctrl+Shift+P)

. . .

2. **Option 3:** In the Terminal via `quarto render`:
